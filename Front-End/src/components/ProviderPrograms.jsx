...
export const MOCK_PROGRAMS = [
  ...
  },
  {
    id: 'prog-6',
    code: 'CHED-AGRI-26',
    title: 'CHED Agriculture & Fisheries Scholarship',
    sector: 'Agriculture',
    region: 'Region IV-A',
    status: 'Published',
    cycle: 'AY 2026-2027',
    ...
    maxIncome: '\u20b1250,000 / year',
    yearLevel: 'All Year Levels',
    residency: 'Region IV-A',
    description: 'Supports students pursuing Agriculture, Fisheries, and allied sciences in CALABARZON state universities and colleges.',
    documents: ['PSA Birth Certificate', 'Form 138 / Transcript of Records', 'Good Moral Certificate', 'Certificate of Indigency or ITR'],
    essayPrompts: ['How will your agriculture studies help your community?'],
    prioritySectors: ['Farmer\'s Child', '4Ps Beneficiary']
  },
  {
    id: 'prog-7',
    code: 'PCARI-RES-26',
    title: 'PCARI Research Scholarship Grant',
    sector: 'Research',
    region: 'Nationwide',
    status: 'Published',
    cycle: 'AY 2026-2027',
    ...
    endDate: 'May 15, 2026',
    gwa: '90% (GWA 1.50)',
    maxIncome: '\u20b1400,000 / year',
    yearLevel: '3rd Year and Above',
    residency: 'Nationwide',
    description: 'Elite research grant for top-performing STEM students engaged in or planning government-funded research projects.',
    documents: ['PSA Birth Certificate', 'Transcript of Records', 'Research Proposal (3-5 pages)', 'Adviser Endorsement Letter'],
    essayPrompts: ['Describe the research problem you aim to solve and its impact.'],
    prioritySectors: ['PWD', 'Indigenous People']
  },
  {
    id: 'prog-8',
    code: 'DIWA-WOM-26',
    title: 'Diwa ng Kababaihan Scholarship',
    sector: 'Gender & Development',
    region: 'Nationwide',
    status: 'Published',
    cycle: 'AY 2026-2027',
    slotsFilled: 38,
    ...
    yearLevel: 'All Year Levels',
    residency: 'Nationwide',
    description: 'Empowerment scholarship for women in non-traditional fields such as engineering, IT, architecture, and maritime studies.',
    documents: ['PSA Birth Certificate', 'Form 138 / Transcript of Records', 'Good Moral Certificate', 'Solo Parent ID or Indigency Certificate (if applicable)'],
    essayPrompts: ['How has being a woman shaped your ambitions in your chosen field?'],
    prioritySectors: ['Solo Parent', 'PWD', 'Indigenous People']
  },
  {
    id: 'prog-4',
    code: 'TESDA-SEP-26',
